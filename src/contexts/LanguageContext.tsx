...
const translations: Record<string, Record<Language, string>> = {
  ...
  "Man's Kurta": { en: "Man's Kurta", hi: "पुरुषों का कुर्ता" },
  "Man's Kurta Design": { en: "Man's Kurta Design", hi: "पुरुषों का कुर्ता डिज़ाइन" },
  "Men's Dress": { en: "Men's Dress", hi: "पुरुषों की पोशाक" },
  "Women's Dress": { en: "Women's Dress", hi: "महिलाओं की पोशाक" },
  ...
  "Men's Innerwear": { en: "Men's Innerwear", hi: "पुरुषों के इनरवियर" },
  ...
  "Women's Innerwear": { en: "Women's Innerwear", hi: "महिलाओं के इनरवियर" },
  "Women's Innerwear Design": { en: "Women's Innerwear Design", hi: "महिलाओं के इनरवियर डिज़ाइन" },
  "Jewelry": { en: "Jewelry", hi: "आभूषण" },
